...
msgResult: .asciiz "El número menor es: "
...
main:
    ...
    # Compara los números y encuentra el menor
    # Compara el primero y el segundo número
    blt $t0, $t1, compare_third
    move $t0, $t1
    
compare_third:
    # Compara el menor de los dos anteriores con el tercer número
    blt $t0, $t2, print_result
    move $t0, $t2
